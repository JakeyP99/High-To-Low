...
public class CharacterClassDescriptions {
    ...
    public static final String survivorPassiveDescription = "If the current number is 1, and you survive a generate, you can hand out half the current drink number.";
