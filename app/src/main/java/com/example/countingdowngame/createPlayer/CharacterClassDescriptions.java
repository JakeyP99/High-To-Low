...
public class CharacterClassDescriptions {
    ...
    public static final String quizMagicianPassiveDescription = "All multi-choice quizzes now have only 2 answers available, instead of 4.";
    ...
    public static final String angryJimPassiveDescription = "When the number is below 50, you gain the passive ability of every class. The catch is, you need to generate the number twice.";
