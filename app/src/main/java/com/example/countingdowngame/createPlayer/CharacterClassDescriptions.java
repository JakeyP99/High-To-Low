...
// Active Ability Descriptions
    ...
    public static final String witchPassiveDescription = "For every even number your player lands on, you can hand out two drinks, but for every odd number you have to take a drink.";
